...
if [ ! "$AUTOGEN_ROUTES_DISABLED" == true ]; then
  ...
  if [ "$(ls -A $LAGOON_AUTOGEN_YAML_FOLDER/)" ]; then
...
# apply dbaas
if [ "$(ls -A $LAGOON_DBAAS_YAML_FOLDER/)" ]; then
...
if [ ! "$CUSTOM_ROUTES_DISABLED" == true ]; then
  ...
  # apply the routes
  if [ "$(ls -A $LAGOON_ROUTES_YAML_FOLDER/)" ]; then
...
if [ ! "$BACKUPS_DISABLED" == true ]; then
  ...
  if [ "$(ls -A $LAGOON_BACKUP_YAML_FOLDER/)" ]; then
