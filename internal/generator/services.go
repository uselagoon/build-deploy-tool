...
func composeToServiceValues(
	...
	if lagoonType != "" {
		...
		if lagoonType == "mariadb" || lagoonType == "postgres" || lagoonType == "mongodb" {
			err := helpers.CheckDBaaSHealth(buildValues.DBaaSOperatorEndpoint)
			if err != nil {
...
func getDBaasEnvironment(
	...
	exists, err := helpers.CheckDBaaSProvider(buildValues.DBaaSOperatorEndpoint, lagoonType, *dbaasEnvironment)
	if err != nil {
