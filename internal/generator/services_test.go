...
func Test_composeToServiceValues(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "test32 - multiline cronjobs",
			args: args{
				buildValues: &BuildValues{
					Namespace:            "example-project-main",
					Project:              "example-project",
				...
				InPodCronjobs: []lagoon.Cronjob{
					{
						...
						Service:  "cli",
						Schedule: "3,8,13,18,23,28,33,38,43,48,53,58 * * * *",
						Command:  "flock -n /tmp/cron.lock.932b8586d96eb88e1574cb8a1223a0b964763c7d0ce90d9aff64d2d92e60fd8d -c 'drush cron'",
						Timeout:  "4h",
						InPod:    helpers.BoolPtr(true),
					},
				},
