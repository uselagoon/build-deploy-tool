...
type BuildValues struct {
	...
	FastlyCacheNoCache            string                       `json:"fastlyCacheNoCache" deprecated:"true" description:"this is the service id of a fastly cache-no-cache service"`
	...
	Route                         string                       `json:"route" description:"this stores the primary determined route after all have been calculated"`
