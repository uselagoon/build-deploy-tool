...
type BuildValues struct {
	...
	ImagePullSecrets              []ImagePullSecrets           `json:"imagePullSecrets" description:"stores any image pull secrets that the deployments in this environment need to know about"`
