...
func Test_generateRoutes(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				envVars: []lagoon.EnvironmentVariable{
					...
					},
					{
						...
						{"domain":"main.example.com","service":"nginx","alternativeNames":[],"annotations":{},"pathRoutes":[],"tlsAcme":true,"insecure":"Redirect","hstsEnabled":false,"hstsIncludeSubdomains":false,"hstsPreload":false,"hstsMaxAge":3153600,"primary":true,"source":"API"},
						{"domain":"other.example.com","service":"nginx","alternativeNames":[],"annotations":{},"pathRoutes":[],"tlsAcme":true,"insecure":"Redirect","hstsEnabled":false,"hstsIncludeSubdomains":false,"hstsPreload":false,"hstsMaxAge":3153600,"primary":false,"source":"API"},
						{"domain":"test.example.com","service":"nginx","alternativeNames":[],"annotations":{},"pathRoutes":[],"tlsAcme":true,"insecure":"Redirect","hstsEnabled":false,"hstsIncludeSubdomains":false,"hstsPreload":false,"hstsMaxAge":3153600,"primary":false,"source":"API"}
						]}`)),
						Scope: "internal_system",
					},
				},
			...
			want:  "https://main.example.com",
			want1: []string{"https://nginx-example-com-main.example.com", "https://main.example.com", "https://other.example.com", "https://test.example.com"},
			want2: []string{"https://nginx-example-com-main.example.com"},
		},
		{
			name: "test-api-defined-routes-with-activestandby",
			args: args{
				envVars: []lagoon.EnvironmentVariable{
					{
						Name:  "LAGOON_SYSTEM_ROUTER_PATTERN",
					...
					},
					{
						Name: "LAGOON_API_ROUTES",
						Value: base64.URLEncoding.EncodeToString([]byte(`{"routes":[
						{"type":"ACTIVE", "domain":"active.example.com","service":"nginx","alternativeNames":[],"annotations":{},"pathRoutes":[],"tlsAcme":true,"insecure":"Redirect","hstsEnabled":false,"hstsIncludeSubdomains":false,"hstsPreload":false,"hstsMaxAge":3153600,"primary":false,"source":"API"},
						{"domain":"other.example.com","service":"nginx","alternativeNames":[],"annotations":{},"pathRoutes":[],"tlsAcme":true,"insecure":"Redirect","hstsEnabled":false,"hstsIncludeSubdomains":false,"hstsPreload":false,"hstsMaxAge":3153600,"primary":false,"source":"API"},
						{"domain":"test.example.com","service":"nginx","alternativeNames":[],"annotations":{},"pathRoutes":[],"tlsAcme":true,"insecure":"Redirect","hstsEnabled":false,"hstsIncludeSubdomains":false,"hstsPreload":false,"hstsMaxAge":3153600,"primary":true,"source":"API"}
						]}`)),
						Scope: "internal_system",
					},
				},
			...
			want1: []string{"https://nginx-example-com-main.example.com", "https://active.example.com", "https://other.example.com", "https://test.example.com"},
			want2: []string{"https://nginx-example-com-main.example.com"},
		},
	}
	for _, tt := range tests {
