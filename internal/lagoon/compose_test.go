...
func TestUnmarshaDockerComposeYAML(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: `{"name":"test12","networks":{"amazeeio-network":{"name":"amazeeio-network","ipam":{},"external":true},"default":{"name":"test12_default","ipam":{}}},"services":{"node":{"build":{"context":".","dockerfile":"node.dockerfile"},"command":null,"entrypoint":null,"environment":{"LAGOON_LOCALDEV_HTTP_PORT":"3000","LAGOON_ROUTE":"http://node.docker.amazee.io"},"labels":{"lagoon.type":"node"},"networks":{"amazeeio-network":null,"default":null},"volumes":[{"type":"volume","source":"node","target":"/app","volume":{}},{"type":"volume","source":"config","target":"/config","volume":{}},{"type":"volume","source":"files","target":"/files","volume":{}}]}},"volumes":{"config":{"name":"test12_config","labels":{"lagoon.type":"persistent"}},"db":{"name":"test12_db","labels":{"lagoon.type":"none"}},"files":{"name":"test12_files","labels":{"lagoon.persistent.size":"10Gi","lagoon.type":"persistent"}},"logs":{"name":"test12_logs"},"node":{"name":"test12_node","labels":{"lagoon.type":"persistent"}},"notused":{"name":"test12_notused","labels":{"lagoon.type":"persistent"}}}}`,
			wantServiceOrder: []OriginalServiceOrder{
				{Index: 0, Name: "node"},
			},
			wantVolumeOrder: []OriginalVolumeOrder{
