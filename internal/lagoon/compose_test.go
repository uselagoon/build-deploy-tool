	...
	tests := []struct {
		...
		},
		{
			...
			wantOrder: []OriginalServiceOrder{
				...
				{Index: 4, Name: "redis"},
				{Index: 5, Name: "chrome"},
				{Index: 6, Name: "wait-dependencies"},
			},
		},
		{
