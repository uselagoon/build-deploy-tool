## lagoon-build template backup-schedule

Generate the backup schedule templates for a Lagoon build

```
lagoon-build template backup-schedule [flags]
```

### Options

```
  -h, --help             help for backup-schedule
      --version string   The version of k8up used. (default "v1")
```
