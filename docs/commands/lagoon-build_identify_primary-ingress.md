## lagoon-build identify primary-ingress

Identify the primary ingress for a specific environment

```
lagoon-build identify primary-ingress [flags]
```

### Options

```
  -h, --help   help for primary-ingress
```
