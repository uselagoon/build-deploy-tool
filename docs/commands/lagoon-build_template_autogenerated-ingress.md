## lagoon-build template autogenerated-ingress

Generate the autogenerated ingress templates for a Lagoon build

```
lagoon-build template autogenerated-ingress [flags]
```

### Options

```
  -h, --help   help for autogenerated-ingress
```
