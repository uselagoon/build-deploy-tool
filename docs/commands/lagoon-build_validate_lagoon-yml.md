## lagoon-build validate lagoon-yml

Verify .lagoon.yml and environment for compatability with this tool

```
lagoon-build validate lagoon-yml [flags]
```

### Options

```
  -h, --help   help for lagoon-yml
```
