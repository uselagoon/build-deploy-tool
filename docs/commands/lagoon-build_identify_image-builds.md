## lagoon-build identify image-builds

Identify the configuration for building images for a Lagoon build

```
lagoon-build identify image-builds [flags]
```

### Options

```
  -h, --help   help for image-builds
```
