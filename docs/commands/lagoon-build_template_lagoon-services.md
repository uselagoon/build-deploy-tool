## lagoon-build template lagoon-services

Generate the lagoon service templates for a Lagoon build

```
lagoon-build template lagoon-services [flags]
```

### Options

```
  -h, --help   help for lagoon-services
```
