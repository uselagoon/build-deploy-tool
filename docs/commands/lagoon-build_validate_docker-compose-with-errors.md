## lagoon-build validate docker-compose-with-errors

Verify docker-compose file for compatability with this tool with next versions of compose-go library

```
lagoon-build validate docker-compose-with-errors [flags]
```
...
```
  ...
  -h, --help                    help for docker-compose-with-errors
```
