	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				envVars:         `[]`,
				secretPrefix:    "fastly-api-",
				lagoonYAML:      "test-resources/template-autogenerated/insecure-single-lagoon.yml",
				templatePath:    "test-resources/template-autogenerated/output",
			},
			emptyDir: false,
		...
		},
		{
			...
			args: args{
				...
				envVars:         `[]`,
				secretPrefix:    "fastly-api-",
				lagoonYAML:      "test-resources/template-autogenerated/single-lagoon-nginxphp.yml",
				templatePath:    "test-resources/template-autogenerated/output",
			},
			emptyDir: false,
		...
		},
		{
			...
			args: args{
				...
				envVars:         `[]`,
				secretPrefix:    "fastly-api-",
				lagoonYAML:      "test-resources/template-autogenerated/single-lagoon-nginxphp2.yml",
				templatePath:    "test-resources/template-autogenerated/output",
			},
			emptyDir: false,
