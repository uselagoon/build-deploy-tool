	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				envVars:         `[]`,
				secretPrefix:    "fastly-api-",
				lagoonYAML:      "test-resources/template-autogenerated/single2-lagoon.yml",
				templatePath:    "test-resources/template-autogenerated/output",
			},
			emptyDir: true,
		...
		},
		{
			...
			args: args{
				...
				envVars:         `[]`,
				secretPrefix:    "fastly-api-",
				lagoonYAML:      "test-resources/template-autogenerated/single3-lagoon.yml",
				templatePath:    "test-resources/template-autogenerated/output",
			},
			emptyDir: false,
		...
		},
		{
			...
			args: args{
				...
				projectVars: `[
					{"name":"LAGOON_SYSTEM_ROUTER_PATTERN","value":"${service}-${project}-${environment}.example.com","scope":"internal_system"},
					{"name":"LAGOON_FASTLY_SERVICE_IDS","value":"node-project-name7-fastly-annotations.example.com:service-id:true","scope":"global"}
					]`,
				envVars:      `[]`,
				secretPrefix: "fastly-api-",
				lagoonYAML:   "test-resources/template-autogenerated/single-lagoon.yml",
