...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&lagoonYmlOverride, "lagoon-yml-envvar", "", "LAGOON_YAML_OVERRIDE",
		"The .lagoon.yml override env var for merging values into target lagoon.yml")
	rootCmd.PersistentFlags().StringVarP(&lagoonYml, "lagoon-yml", "l", ".lagoon.yml",
		"The .lagoon.yml file to read")
