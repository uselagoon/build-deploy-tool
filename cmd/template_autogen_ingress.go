...
func AutogeneratedIngressGeneration(debug bool) error {
	...
	// 			autgenPrefixes := lYAML.Routes.Autogenerate.Prefixes
	...
	// 			err := lagoon.GenerateFastlyConfiguration(fastlyConfig, fastlyCacheNoCahce, fastlyServiceID, domain, fastlyAPISecretPrefix, lagoonEnvVars)
	// 			if err != nil {
	// 				return err
	// 			}
