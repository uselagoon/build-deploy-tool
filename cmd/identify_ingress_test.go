...
func TestIdentifyRoute(t *testing.T) {
	tests := []struct {
		...
		{
			name: "test17 autogenerated routes with multiple routeable services",
			args: testdata.GetSeedData(
				testdata.TestData{
					ProjectName:     "example-project",
					EnvironmentName: "main",
		...
		},
		{
			...
			want:        "https://example.com",
			wantRemain:  []string{"https://node-example-project-twootherroutes.example.com", "https://example.com", "https://www.example.com", "https://example2.com", "https://en.example2.com", "https://www.example2.com", "https://www.example3.com", "https://example3.com", "https://www.example4.com", "https://example4.com", "https://en.example4.com"},
			wantautoGen: []string{"https://node-example-project-twootherroutes.example.com"},
			wantJSON:    `{"primary":"https://example.com","secondary":["https://node-example-project-twootherroutes.example.com","https://example.com","https://www.example.com","https://example2.com","https://en.example2.com","https://www.example2.com","https://www.example3.com","https://example3.com","https://www.example4.com","https://example4.com","https://en.example4.com"],"autogenerated":["https://node-example-project-twootherroutes.example.com"]}`,
		},
	}
