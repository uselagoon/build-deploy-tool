...
func generatorInput(debug bool) (generator.GeneratorInput, error) {
	...
	if err != nil {
		return generator.GeneratorInput{}, fmt.Errorf("error reading fastly-api-secret-prefix flag: %v", err)
	}
